...
If using Playwright automation for direct JiBe connection, install Chromium:
```bash
...
Choose how to get your PMS data:
- **Upload CSV/Excel:** Select a PMS export file from your computer
- **Fetch via JiBe URL:** 
  - **Playwright automation** (recommended) — paste your JiBe job status URL, and
    the app automates login and export using a headless browser
  - **Manual link** — get a direct export link to download manually

### 📊 Analysis (Page 2)

1. Pick a reporting period in the sidebar: **1 Week, 1 Month, 3 Months, 6 Months**.
2. Optional filters: Department, Function, Job Status, Critical-only, and
